...
Line 30 and 35 - I've wrapped the fields I want to be requiered with <p> elements (could be div, etc) with a class of "required-field". Pleae note that this isn't the original jquery.validation plugin. It's been hacked by me to perform this way.
